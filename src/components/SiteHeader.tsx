          ...
          <div className="flex items-center gap-2">
            {showAccount && user && !isAdmin && (
              <Link
                ...
                className="inline-flex h-10 items-center gap-2 rounded-full border border-border px-3 text-sm font-medium transition-colors hover:bg-muted bg-cyan-600 text-slate-100 shadow-2xl"
