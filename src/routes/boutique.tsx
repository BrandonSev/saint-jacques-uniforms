      ...
      <section className="relative overflow-hidden border-b border-border" style={{ background: "var(--gradient-soft)" }}>
        ...
        <div className="relative mx-auto w-full px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
            La sélection Collège est <span className="inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 font-semibold uppercase tracking-wider text-[10px] text-lime-400 bg-red-500">EN COURS D'ÉTUDE PAR L'ÉTABLISSEMENT</span>.
