      ...
      <section className="relative overflow-hidden border-b border-border" style={{ background: "var(--gradient-soft)" }}>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
            Chaque niveau dispose d'une <span className="inline-block rounded-full px-4 py-1.5 font-semibold uppercase tracking-wider text-sm text-lime-400 bg-red-500 align-middle">SÉLECTION EN COURS D'ETUDE PAR L'ÉTABLISSEMENT</span>.
