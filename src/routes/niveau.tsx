...
const levels = [
  ...
  {
    id: "lycee",
    title: "Uniformes lycée",
    subtitle: "Lycée",
    range: "2nde · 1re · Terminale",
    image: lycee,
    href: "/lycee" as const,
    accent: "Tenue sobre & élégante",
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-4 pt-12 sm:px-6 lg:px-8">
        <div className="text-center">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-secondary px-3 py-1 text-[11px] font-medium uppercase tracking-wider text-primary">
