...
function WelcomeEmail({ prenom, appUrl = APP_URL }: Props) {
  return (
    <EmailLayout
      preview="Bienvenue sur la boutique du groupe scolaire Saint-Jacques-de-Compostelle"
      title="Bienvenue !"
    >
      <Text style={text}>Bonjour {prenom || ""},</Text>
      <Text style={text}>
        Votre compte sur la boutique du groupe scolaire <strong>Saint-Jacques-de-Compostelle</strong> a bien été créé.
      </Text>
...
export const template = {
  ...
  subject: "Bienvenue sur la boutique du groupe scolaire de Saint-Jacques-de-Compostelle",
