// Générateur ZIP minimal (méthode « stored », sans compression) : les PDF de factures sont déjà
// compressés, et cela évite une dépendance supplémentaire (le lockfile bun est figé en CI).
...
export function createZip(entries: ZipEntry[], now: Date = new Date()): Uint8Array {
  ...
  for (const entry of entries) {
    ...
    local.setUint16(6, 0x0800, true); // noms de fichiers en UTF-8
